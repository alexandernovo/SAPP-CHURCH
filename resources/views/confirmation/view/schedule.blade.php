...
@section('title', 'Confirmation — Schedule Request — ' . config('app.name', 'SAPP Church'))
        ...
        <div class="sappc-registry-page_head">
            ...
            <div class="sappc-registry-page_actions">
                <button type="button"
                    ...
                    id="confirmationNewRecordBtn"
                    data-bs-toggle="modal"
                    data-bs-target="#confirmationScheduleRequestModal"
